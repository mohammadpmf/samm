...
btn_start_1 = tk.Button(lbl_frm1, text="Start")
btn_reset_1 = tk.Button(lbl_frm1, text="Reset")
btn_start_2 = tk.Button(lbl_frm2, text="Start")
btn_reset_2 = tk.Button(lbl_frm2, text="Reset")
btn_start_3 = tk.Button(lbl_frm3, text="Start")
btn_reset_3 = tk.Button(lbl_frm3, text="Reset")
btn_start_1.grid(row=3, column=1)
btn_reset_1.grid(row=3, column=3)
btn_start_2.grid(row=3, column=1)
btn_reset_2.grid(row=3, column=3)
btn_start_3.grid(row=3, column=1)
btn_reset_3.grid(row=3, column=3)
root.mainloop()